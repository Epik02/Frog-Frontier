...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Milena Novakovic - 100781346", nullptr, nullptr);
...
int main() {
	...
	static const GLfloat points[] = {
		//X, Y, Z
		-1.0f, -0.75f, 0.5f, //vert1
		-0.5f, -0.75f, 0.5f, //vert2
		-0.75f, -0.25f, 0.5f, //vert3
		//second trianlge coordi
		-0.25f, -0.75f, 0.5f,
		0.25f, -0.75f, 0.5f,
		0.0, -0.25f, 0.5f,
	};

	static const GLfloat translated_points [] = {
		0.0f, -0.5f, 0.5f,
		1.0f, -0.5f, 0.5f,
		0.5, 0.5f, 0.5f,
	};
	...
	//glBufferData(GL_ARRAY_BUFFER, sizeof(points), transform_points, GL_STATIC_DRAW);
